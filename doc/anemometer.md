...
Electronics and other sensors are located  above the transducer in shielded box. 

I even managed to make a air flow simulation using [Simscale](https://www.simscale.com/).
The air flow speed is set to `30m/s` equivalent to `~58knots`, near a center of a storm. 
...
As shown in the introduction, the sound beam should travels along the noted path. 
...
- The 3D printed plastic is rigid and light-weight, perfect for amplifying a sound. The reflector might also be a speaker.  
